...
The current maintenance agency is listed on the [ISO maintenance agency website](https://www.iso.org/maintenance_agencies.html#5345). Parties who wish to request an ITS-AID should submit a completed [ITS-AID request form](ITS-AID_Request_Form.pdf) to the maintenance agency. Parties who wish to request any other change to the lists of registered items should submit a completed request [form](ITS_Identifier_Request_Form.pdf) to the maintenance agency.
